...
\frontend\assets\GoodAsset::register($this);
?>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=Html::a($goods->name)?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=Html::img('http://admin.yii2shop.com'.$goods->logo,['style'=>'width:350px'])?>          <!-- 第一幅图片的中图 -->
                    </a>
                </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=Html::a($goods->sn)?></li>
                    <li class="market_price"><span>定价：</span><em>￥<?=Html::a($goods->market_price)?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=Html::a($goods->shop_price)?></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=Html::a(date('Y-m-d',$goods->create_time))?></li>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?=Html::img('http://admin.yii2shop.com'.$img->url)?>
